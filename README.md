...
to get a personal export key and setup instructions. It transfers nutrition and
weight through the Mini App HTTPS server, tracks confirmed samples, and pauses
